(function ($) {
    ...
    var FilterMultiSelect = (function () {
        ...
        FilterMultiSelect.prototype.unqueueOption = function (option) {
            ...
            $__default["default"](this.selectedItems)
                .children('[data-id="' + option.getSelectedItemBadge().getAttribute("data-id") + '"]')
                .remove();
        };
    ...
    $__default["default"](function () {
        var selector = typeof $__default["default"].fn.filterMultiSelect.selector === "undefined" ? "select.filter-multi-select" : $__default["default"].fn.filterMultiSelect.selector;
...
const Filter1 = $('#filter1').filterMultiSelect({
...
const Filter2 = $('#filter').filterMultiSelect({
      placeholderText: "nothing selected",
      filterText: "Filter",
      selectAllText: "Select All",
      caseSensitive: false,
